...
List<dynamic> favoritesVideoNotify = [];

Map<dynamic, List<dynamic>> playlist = {};

List<dynamic> playlistKey = [];

ValueNotifier<List<dynamic>> VideoHistoryListNotifier = ValueNotifier([]);
...
void removeLikedVideo(int index, BuildContext context) {
  ...
  BlocProvider.of<FavoriteBloc>(context)
      .add(RemoveFavoriteVideo(videoPath: favoritesVideoNotify[index]));
